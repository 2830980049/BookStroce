                        ...
                        <div class="imfor">
                            ...
                            <div class="pudc">
                                <div class="pudc_information" id="1">
                                    <img src="../img/goods/${cart.isbn}/detail1.jpg" class="lf"/>
                                    <input type="hidden" name="" value="">
                                    <span class="des lf">
                         ${cart.title}
                              <input type="hidden" name="" value="">
                        </span>
                                    <p class="col lf"><span>作者：</span><span
                                            class="color_des">${cart.author}<input type="hidden" name=""
                                                                                   value=""></span></p>
                                </div>
                            </div>
                            <div class="pices">
                                <p class="pices_des"></p>
                                <p class="pices_information"><b>￥</b><span>${cart.price}<input type="hidden" name=""
                                                                                               value=""></span>
                                </p>
                            </div>
                            <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text"
                                                                                            value="${cart.count}"><span
                                    class="add">&nbsp;+&nbsp;</span></div>
                            <div class="totle">
                                <span>￥</span>
                            ...
                            <div class="del">
                                <a href="javascript:;" onclick="delCart(${cart.isbn});" class="del_d">删除</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
...
<script>
    ...
    function delCart(val) {
        var result = window.confirm("您确定删除该宝贝?");
        if (result) {
            window.location.href = "delCartDetail.do?product=" + val;
        }
    }
</script>
</body>
