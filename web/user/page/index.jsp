...
<header id="top">
    ...
    <div id="top_input" class="lf">
        ...
        <a onclick="Search();" class="rt"><img id="search" src="../img/header/search.png" alt="搜索"/></a>
    </div>
    <div class="rt">
        <ul class="lf">
...
<div class="store">
    ...
    <div class="store_content">
        <c:forEach items="${pageBean.listBean}" var="list">
            <div>
                <a href="detail.do?isbn=${list.isbn}&user_id=${user.phone}"><img
                        src="../img/goods/${list.isbn}/index.jpg" alt=""/></a>
    ...
    <p style="text-align: center;">
        <span>第${pageBean.pageCode}页/共${pageBean.totalPage}页</span>
        <a href="index.jsp?page=1">首页</a>
        <c:if test="${pageBean.pageCode>1}">
            <a href="index.jsp?page=${pageBean.pageCode-1}">上一页</a>
        </c:if>
        <c:choose>
        ...
        <c:if test="${pageBean.pageCode<pageBean.totalPage}">
            <a href="index.jsp?page=${pageBean.pageCode+1}">下一页</a>
        </c:if>
        <a href="index.jsp?page=${pageBean.totalPage}">尾页</a>
        <input id="page" type="text" size="1">
        <span hidden="true">${pageBean.totalPage}</span>
        <input type="button" value="跳转" onclick="trun();">
    </p>
    <!-- 品质保障，私人定制等-->
    <div id="foot_box">
        <div class="icon1 lf">
